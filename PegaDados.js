...
class Proposta {
    ...
    get bloqemprestimo() { return this._bloqemprestimo; }
    set bloqemprestimo(valor) { this._bloqemprestimo = valor; }

    get elegemprestimo() { return this._elegemprestimo; }
    set elegemprestimo(valor) { this._elegemprestimo = valor; }
...
async function pegaDados(page) {
    ...
    novaProposta.uf = await page.querySelectorAll('small.mb-0')[0];
    novaProposta.municipio = await page.querySelectorAll('small.mb-0')[1];
    novaProposta.cep = await page.querySelectorAll('small.mb-0')[2];
    novaProposta.logradouro = await page.querySelectorAll('small.mb-0')[3];
    novaProposta.banco = await page.querySelectorAll('small.mb-0.text-gray.fw-bold')[0];
    novaProposta.uf = await page.querySelectorAll('small.mb-0')[4];
    novaProposta.agencia = await page.querySelectorAll('small.mb-0')[5];
    novaProposta.conta = await page.querySelectorAll('small.mb-0')[6];
    novaProposta.tipoconta = await page.querySelectorAll('small.mb-0.text-info')[0];
    novaProposta.banco = await page.querySelectorAll('small.mb-0.text-sucess')[0];
    novaProposta.pensao = await page.querySelectorAll('small.mb-0.text-sucess')[1];
    novaProposta.representante = await page.querySelectorAll('small.mb-0.text-sucess')[2];
    novaProposta.bloqemprestimo = await page.querySelectorAll('small.mb-0.text-danger')[0];
    novaProposta.elegemprestimo = await page.querySelectorAll('small.mb-0.text-sucess')[3];
    novaProposta.descbloq = await page.querySelectorAll('small.mb-0.text-danger')[1];
    novaProposta.dataext = await page.querySelectorAll('small.mb-0')[7];
